...
namespace ProjetoFundacaoCrianca.Controllers
{
    public class AtividadesController : Controller
    {
        ...
        public AtividadesController(Contexto context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,descricao,DataAtividade,duracaoAtividade")] Atividade atividade)
        {
            if (id != atividade.id)
            {
                return NotFound();
